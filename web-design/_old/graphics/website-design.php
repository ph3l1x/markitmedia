...
//get vars
$page = 3;
$pageName = 'Design - Website Design';
...
?>
<div class="wrapper">
	<div class="pageContent webDesign">
...
<div id="content">
    ...
    <div id="contentBody">
    	<div class="wrapper">
        	<div class="welcome">
                <div class="left">
                	<h1>Wow you customers with custom professional web design</h1>
                    <p>Our web design team will schedule an appointment with you to go over key elements and functionality of your website, to ensure that your website has everything you need to run your business. We program in a variety of scripting languages, so no matter what you server configuration, we are the right fit for the job.</p>
                    <p>New to the web? No problem. Our web developers will set you up with the right products and hosting to get your website up and running.  We offer web hosting, email hosting, domains and other products you need to get started. </p>
                    <p>A custom. professional website says a lot about your company to new customers, so let our professional design team create a comprehensive website to help drive business and products from your website.</p>
