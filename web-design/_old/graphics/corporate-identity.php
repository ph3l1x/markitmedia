...
//get vars
$page = 3;
$pageName = 'Design - Corporate Identity';
...
<div class="wrapper">
	<div class="pageContent webDesign">
    	<h1>Brand your Business with Professional Design</h1>
...
<div id="content">
    ...
    <div id="contentBody">
    	<div class="wrapper">
        	<div class="welcome">
                <div class="left">
                	<h1>Let us Create your Corporate Identity</h1>
                    <p>Our design team will meet with you to create your colors, logo and design to give you a professional, consistent look to use across all your advertising medium. Having a uniformed identity will help get your brand out to the world and start building visual rapport with your customers.</p>
                    <p>Your Corporate Identity will carry across to everything you do, whether it is online advertisements such as email marketing, splash pages, ad space, etc.. or printed material: apparel, promotional goods, business cards, flyers, banners and more. </p>
                    <p>Having a consistent look will help your customers and new customers alike recognize your marketing and associate it with your business. </p>
                </div>
                <div class="right">
