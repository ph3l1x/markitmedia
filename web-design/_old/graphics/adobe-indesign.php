...
//get vars
$page = 3;
$pageName = 'Design - Adobe InDesign';
...
<div class="wrapper">
	<div class="pageContent webDesign">
    	<h1>Experts in Adobe InDesign will Publish works of Art</h1>
...
<div id="content">
    ...
    <div id="contentBody">
    	<div class="wrapper">
        	<div class="welcome">
                <div class="left">
                	<h1>Publication made Easy With Adobe InDesign</h1>
                    <p>Markit Media's design experts are well versed on all Adobe and major design software. With the use of InDesign we can help you keep industry standards by designing your publications, brochures and more with the right software.</p>
                    <p>Do you need help with existing files done in Adobe InDesign? We can help! Our design team always has the latest software and the know how to deal with all file types from various programs.</p>
                    <p>Really wow your customers with professional designs and layouts. We aim to impress!</p>
