...
//get vars
$page = 3;
$pageName = 'Design - Proposals / Resumes';
...
<div class="wrapper">
	<div class="pageContent webDesign">
    	<h1>Professionally Design Proposals and Resumes</h1>
...
<div id="content">
    ...
    <div id="contentBody">
    	<div class="wrapper">
        	<div class="welcome">
                <div class="left">
                	<h1>Ensure success with Professionals Resumes and Proposals</h1>
                    <p>If you have a big client and need to impress them, have our design team create a impressive, unique business proposal. Show your customers your level of professionalism with professionally designed documentation.</p>
                    <p>If your resume needs to be updated, or you are just looking for a way to stand out, let us design your resume for you. Break away from the normal and have a custom designed resume that screams your personality and skills.  Standing out from the rest will give you the edge on your competitors.</p>
                </div>
                <div class="right">
