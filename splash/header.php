    	...
    	<div id="domainSearch2">
                ...
                <form qaid="1" style="margin:0px" name="RegisterDomainForm" id="RegisterDomainForm" method="POST" onSubmit="return checkDomain(this);"  action="https://www.securepaynet.net/gdshop/registrar/search.asp?prog_id=451792"><input type="hidden" name="postBack" value="true">
                    ...
                    <select style="float:left;" qaid="2018" name="tld" class="dropdown">
                      ...
                      <input class="searchBtn" qaid="2020" type="image" src="https://img1.wsimg.com/fos/base/0/53845_btn_search.png" border="0" width="65" height="20" alt="Check Domain Name" id=image1 name=image1>
                </form>
                <div class="clear"></div>
            </div>
    	<ul class="topNav">
...
<div class="wrapper">
	<div id="header">
        ...
        <div id="follow">
        <div id="follow2-top">
        <img src="<?php echo $siteroot; ?>images/icon-godaddy.png" class="imagespace2"/><img src="<?php echo $siteroot; ?>images/icon-google.png" class="imagespacer"/><img src="<?php echo $siteroot; ?>images/icon-yahoo.png" class="imagespacer"/>
        </div>
         <div id="follow2-middle">
        <img src="<?php echo $siteroot; ?>images/icon-magento.png" class="imagespacer"/><img src="<?php echo $siteroot; ?>images/wht-box-bg.png" class="imagespacer"/><img src="<?php echo $siteroot; ?>images/icon-bing.png" class="imagespacer"/>
        </div>
         <div id="follow2-btm">
         <img src="<?php echo $siteroot; ?>images/icon-wordpress.png" class="imagespace2"/><img src="<?php echo $siteroot; ?>images/icon-sql.png" class="imagespacer"/><img src="<?php echo $siteroot; ?>images/icon-php.png" class="imagespacer"/>
        </div>
