...
//get vars
$page = 7;
$pageName = 'Promotional Signage';
$title = 'Promotional Signage ';
$description = 'Call (480) 245-4287 for 24/7/365 for  Promotional Sign Design and Printing.  Promotional signs are portable and affordable.  Let Markit Media Help you with the design and printing of your new promotional sign.';
$keywords = 'Promotional sign in Scottsdale, Promotional signs in Phoenix, Scottsdale Signs, Phoenix Signs, Sign Printing in Scottsdale AZ, Buy Sign in Scottsdale, Buy Sign in Phoenix';
...
<div class="wrapper">
    <div id="signsPromotion" class="pageContent page-head">
        <div class="pageContent-Inner">
            ...
            <img src="/images/bas-feather-flags-PLA-splash.png" width="325">
            </div><!-- /Image on Right -->


            <div class="page-button-contain">
                <div class="page-button"><img src="/images/mm_signs.png"></div>
                <div class="page-button-text"><h1>PROMOTIONAL SIGNS</h1></div>
            </div>
            <h2>Use promotional sign products to raise brand awareness.</h2>
...
<div id="content">
    ...
    <div id="contentBody">
        <div class="wrapper">
            <div class="welcome">
                <div class="left">
                    <h1>Promotional Signage</h1>
                    <p>If you want to operate a successful retail business that attracts customers
                       and drives sales, then you need to get noticed, and that usually starts
                       with signage.</p>
                    <p>Outdoor Signage which can take the form of sidewalk signs, entrance signs,
                       awnings or window signs.</p>
                    <p style="padding-top:15px;">Our expert team at Markit Media can help you choose the best Promotional Signage
