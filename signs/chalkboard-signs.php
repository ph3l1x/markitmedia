...
//get vars
$page = 7;
$pageName = 'Chalkboard Signs';
$title = 'Chalkboard Signs ';
$description = 'Call (480) 245-4287 for 24/7/365 for Chalkboard Sign Design and Printing. Chalkboard Signs are portable and affordable. Let Markit Media Help you with the design and printing of your new Chalkboard sign.';
$keywords = 'Chalkboard Signs in Scottsdale, Chalkboard Signs in Phoenix, Scottsdale Signs, Phoenix Signs, Sign Printing in Scottsdale AZ, Buy Sign in Scottsdale, Buy Sign in Phoenix';
...
<div class="wrapper">
    <div id="signsPromotion" class="pageContent page-head">
        <div class="pageContent-Inner">
            ...
            <img src="/images/chalkboard.jpg" width="450">
            </div><!-- /Image on Right -->


            <div class="page-button-contain">
                <div class="page-button"><img src="/images/mm_signs.png"></div>
                <div class="page-button-text"><h1>CHALKBOARD SIGNS</h1></div>
            </div>
            <h2>Make an impression with a chalkboard sign!</h2>
...
<div id="content">
    ...
    <div id="contentBody">
        <div class="wrapper">
            <div class="welcome">
                <div class="left">
                    <h1>Chalkboard Signage</h1>
                    <p>
                        What better way than to display your daily deals and specials than with a Chalkboard Sign.
                        Messages can easily be added and removed. Chalkboard signs are a must-have for any business
                        owner.
                    </p>
                    <p style="padding-top:15px;">Our expert team at Markit Media can help you choose the best Chalkboard Signage
