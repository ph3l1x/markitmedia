...
function sociable_reset()
{
    ...
    $sociable_known_sites = array(
        ...
        'Facebook Counter' => array(
            ...
            'url' => '<iframe src="https://www.facebook.com/plugins/like.php?href=PERMALINKCOUNT&send=false&layout=button_count&show_faces=false&action=like&colorscheme=light&font" scrolling="no" frameborder="0" style="border:none; overflow:hidden;height:32px;width:100px" allowTransparency="true"></iframe>',
            'spriteCoordinates' => Array(
                '16' => array(
                    "-48px",
                    "0px"
        ...
        'Twitter' => array(
            'favicon' => 'twitter.png',
            'url' => 'https://twitter.com/intent/tweet?text=TITLE%20-%20PERMALINK%20  SHARETAG',
            'spriteCoordinates' => Array(
                '16' => array(
                    "-144px",
                    "-16px"
        ...
        'LinkedIn Counter' => array(
            'counter' => 1,
            'favicon' => 'linkedin.png',
            'url' => '<script src="https://platform.linkedin.com/in.js" type="text/javascript"></script><script type="IN/Share" data-url="PERMALINKCOUNT" data-counter="right"></script>',
            'spriteCoordinates' => Array(
                '16' => array(
                    "-144px",
                    "0px"
        ...
        'Digg Counter' => array(
            'counter' => 1,
            'favicon' => 'digg.png',
            'url' => "<script type='text/javascript'>(function() {var s = document.createElement('SCRIPT'), s1 = document.getElementsByTagName('SCRIPT')[0];s.type = 'text/javascript';s.async = true;s.src = 'https://widgets.digg.com/buttons.js';s1.parentNode.insertBefore(s, s1);})();</script><a href='http://digg.com/submit?url=PERMALINK&amp;title=TITLE'  class='DiggThisButton DiggCompact'></a>",
            'spriteCoordinates' => Array(
                '16' => array(
                    "-32px",
                    "0px"
        ...
        'StumbleUpon Counter' => array(
            'counter' => 1,
            'favicon' => 'stumbleupon.png',
            'url' => '<script src="https://www.stumbleupon.com/hostedbadge.php?s=2&r=PERMALINKCOUNT"></script>',
            'spriteCoordinates' => Array(
                '16' => array(
                    "-112px",
                    "-16px"
        ...
        'vuible' => array(
            'favicon' => 'vuible.png',
            'url' => 'https://vuible.com/pins-settings/?m=bm&imgsrc=SOURCE&source=PERMALINK&title=TITLE&video=0',
            'spriteCoordinates' => Array(
                '16' => array(
                    "-112px",
                    "-16px"
        ...
        'MSNReporter' => Array(
            'favicon' => 'msn.png',
            'url' => 'https://reporter.es.msn.com/?fn=contribute&amp;Title=TITLE&amp;URL=PERMALINK&amp;cat_id=6&amp;tag_id=31&amp;Remark=EXCERPT',
        ...
        'Google Reader' => array(
            ...
            'url' => 'https://www.google.com/reader/link?url=PERMALINK&amp;title=TITLE&amp;srcURL=PERMALINK&amp;srcTitle=BLOGNAME',
            'spriteCoordinates' => Array(
                '16' => array(
                    "-112px",
                    "0px"
