...
<table width="100%">
    ...
    <tr>
        ...
        <td valign="top">
            ...
            <p>
                If you want to sign up a "Lead" rather than a "Customer" please change the hidden customer[type] field from 0 to 1, like below: <br>
                &lt;input type="hidden" name="customer[type]" value="<?php echo _CUSTOMER_TYPE_LEAD;?>"&gt;
            </p>
	        <p>
