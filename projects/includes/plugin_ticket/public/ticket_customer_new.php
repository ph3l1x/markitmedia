						...
						<tbody>
							...
							<tr>
								...
								<td>
                                    ...
                                    echo print_select_box($types,'ticket_type_id',isset($_REQUEST['ticket_type_id'])&&isset($types[$_REQUEST['ticket_type_id']])?$_REQUEST['ticket_type_id']:$ticket_account['default_type'],'',false);
                                    ?>
								</td>
							</tr>
                            <?php } ?>
