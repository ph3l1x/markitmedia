...
/** 
  ...
  * Package Date: 2015-01-24 12:42:39 
...
','New Comment on your Job: {JOB_NAME}',array(
    ...
    <div class="task_job_discussion_comments">
        ...
        foreach($send_to_customer_ids as $user_id => $tf){
            ...
            ?>
            <br/>
            <input type="checkbox" name="sendemail_customer[]" value="<?php echo $user_id;?>" <?php echo module_config::c('job_discussion_customer_checked',1) && $user_id == $customer['primary_user_id'] ? 'checked="checked"':'';?> class="sendemail_customer"> <?php _e('Yes, send email to customer contact %s',module_user::link_open($user_id,true));?>
