...
/** 
  ...
  * Package Date: 2015-01-24 12:41:28 
...
<form action="<?php echo module_change_request::link_popup($website_id);?>&type=save" method="post" enctype="multipart/form-data" id="change_request_submit_form">
    ...
    <p>
        <?php if($change_id){ ?>
	        <?php if(!isset($change_request['job_id']) || !$change_request['job_id']){ ?>
        <input type="submit" name="delete_request" value="Delete" class="wp3changerequest_button wp3changerequest_button_cancel" onclick="return confirm('<?php _e('Really delete this?');?>');">
