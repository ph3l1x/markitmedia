...
/** 
  ...
  */
// $Header: /cvsroot/html2ps/encoding.windows-1250.inc.php,v 1.4 2007/01/24 18:56:00 Konstantin Exp $

$GLOBALS['g_windows_1250'] = array(
                        "\x00" => 0x0000, // NULL
                        ...
                        "\x8A" => 0x0160, // LATIN CAPITAL LETTER S WITH CARON
                        "\x8B" => 0x2039, // SINGLE LEFT-POINTING ANGLE QUOTATION MARK
                        "\x8C" => 0x015A, // LATIN CAPITAL LETTER S WITH ACUTE
                        "\x8D" => 0x0164, // LATIN CAPITAL LETTER T WITH CARON
                        "\x8E" => 0x017D, // LATIN CAPITAL LETTER Z WITH CARON
                        "\x8F" => 0x0179, // LATIN CAPITAL LETTER Z WITH ACUTE
                        //0x90	      	#UNDEFINED
                        ...
                        "\x9A" => 0x0161, // LATIN SMALL LETTER S WITH CARON
                        "\x9B" => 0x203A, // SINGLE RIGHT-POINTING ANGLE QUOTATION MARK
                        "\x9C" => 0x015B, // LATIN SMALL LETTER S WITH ACUTE
                        "\x9D" => 0x0165, // LATIN SMALL LETTER T WITH CARON
                        "\x9E" => 0x017E, // LATIN SMALL LETTER Z WITH CARON
                        "\x9F" => 0x017A, // LATIN SMALL LETTER Z WITH ACUTE
                        "\xA0" => 0x00A0, // NO-BREAK SPACE
                        "\xA1" => 0x02C7, // CARON
                        "\xA2" => 0x02D8, // BREVE
                        "\xA3" => 0x0141, // LATIN CAPITAL LETTER L WITH STROKE
                        "\xA4" => 0x00A4, // CURRENCY SIGN
                        "\xA5" => 0x0104, // LATIN CAPITAL LETTER A WITH OGONEK
                        "\xA6" => 0x00A6, // BROKEN BAR
                        "\xA7" => 0x00A7, // SECTION SIGN
                        "\xA8" => 0x00A8, // DIAERESIS
                        "\xA9" => 0x00A9, // COPYRIGHT SIGN
                        "\xAA" => 0x015E, // LATIN CAPITAL LETTER S WITH CEDILLA
                        "\xAB" => 0x00AB, // LEFT-POINTING DOUBLE ANGLE QUOTATION MARK
                        "\xAC" => 0x00AC, // NOT SIGN
                        "\xAD" => 0x00AD, // SOFT HYPHEN
                        "\xAE" => 0x00AE, // REGISTERED SIGN
                        "\xAF" => 0x017B, // LATIN CAPITAL LETTER Z WITH DOT ABOVE
                        "\xB0" => 0x00B0, // DEGREE SIGN
                        "\xB1" => 0x00B1, // PLUS-MINUS SIGN
                        "\xB2" => 0x02DB, // OGONEK
                        "\xB3" => 0x0142, // LATIN SMALL LETTER L WITH STROKE
                        "\xB4" => 0x00B4, // ACUTE ACCENT
                        "\xB5" => 0x00B5, // MICRO SIGN
                        "\xB6" => 0x00B6, // PILCROW SIGN
                        "\xB7" => 0x00B7, // MIDDLE DOT
                        "\xB8" => 0x00B8, // CEDILLA
                        "\xB9" => 0x0105, // LATIN SMALL LETTER A WITH OGONEK
                        "\xBA" => 0x015F, // LATIN SMALL LETTER S WITH CEDILLA
                        "\xBB" => 0x00BB, // RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK
                        "\xBC" => 0x013D, // LATIN CAPITAL LETTER L WITH CARON
                        "\xBD" => 0x02DD, // DOUBLE ACUTE ACCENT
                        "\xBE" => 0x013E, // LATIN SMALL LETTER L WITH CARON
                        "\xBF" => 0x017C, // LATIN SMALL LETTER Z WITH DOT ABOVE
                        "\xC0" => 0x0154, // LATIN CAPITAL LETTER R WITH ACUTE
                        "\xC1" => 0x00C1, // LATIN CAPITAL LETTER A WITH ACUTE
                        "\xC2" => 0x00C2, // LATIN CAPITAL LETTER A WITH CIRCUMFLEX
                        "\xC3" => 0x0102, // LATIN CAPITAL LETTER A WITH BREVE
                        "\xC4" => 0x00C4, // LATIN CAPITAL LETTER A WITH DIAERESIS
                        "\xC5" => 0x0139, // LATIN CAPITAL LETTER L WITH ACUTE
                        "\xC6" => 0x0106, // LATIN CAPITAL LETTER C WITH ACUTE
                        ...
                        "\xEC" => 0x011B, // LATIN SMALL LETTER E WITH CARON
                        "\xED" => 0x00ED, // LATIN SMALL LETTER I WITH ACUTE
                        "\xEE" => 0x00EE, // LATIN SMALL LETTER I WITH CIRCUMFLEX
                        "\xEF" => 0x010F, // LATIN SMALL LETTER D WITH CARON
                        "\xF0" => 0x0111, // LATIN SMALL LETTER D WITH STROKE
                        "\xF1" => 0x0144, // LATIN SMALL LETTER N WITH ACUTE
                        "\xF2" => 0x0148, // LATIN SMALL LETTER N WITH CARON
                        "\xF3" => 0x00F3, // LATIN SMALL LETTER O WITH ACUTE
                        "\xF4" => 0x00F4, // LATIN SMALL LETTER O WITH CIRCUMFLEX
                        "\xF5" => 0x0151, // LATIN SMALL LETTER O WITH DOUBLE ACUTE
                        "\xF6" => 0x00F6, // LATIN SMALL LETTER O WITH DIAERESIS
                        "\xF7" => 0x00F7, // DIVISION SIGN
                        "\xF8" => 0x0159, // LATIN SMALL LETTER R WITH CARON
                        "\xF9" => 0x016F, // LATIN SMALL LETTER U WITH RING ABOVE
                        "\xFA" => 0x00FA, // LATIN SMALL LETTER U WITH ACUTE
                        "\xFB" => 0x0171, // LATIN SMALL LETTER U WITH DOUBLE ACUTE
                        "\xFC" => 0x00FC, // LATIN SMALL LETTER U WITH DIAERESIS
                        "\xFD" => 0x00FD, // LATIN SMALL LETTER Y WITH ACUTE
                        "\xFE" => 0x0163, // LATIN SMALL LETTER T WITH CEDILLA
                        "\xFF" => 0x02D9 // DOT ABOVE
                        );
                        ?>