...
//get vars
$page = 3;
$pageName = 'Design - Adobe Photoshop';
...
?>
<div class="wrapper">
	<div id="adobePhotoshop" class="pageContent webDesign">
    	<h1>Our Design Team Creates Stunning Graphics with the Industry Standard, Adobe Photoshop</h1>
        <a href="<?php echo $siteroot; ?>portfolio/"><img class="portfolio" src="<?php echo $siteroot; ?>images/portfolio_btn.png" width="213" height="84" border="0" /></a>		<img class="main_graph" src="../images/adobe-photoshop.jpg" width="" height="" border="0">						
    </div>
</div>
<div id="content">
    ...
    <div id="contentBody">
    	<div class="wrapper">
        	<div class="welcome">
                <div class="left">
                	<h1>Whether it's Photo Editing or creating art from scratch we do it all with Photoshop</h1>
                    <p>Our designers use Adobe Photoshop to create works of art from scratch, such as websites, flyers, magazine ads and more. Our expert use every tool that Photoshop has to offer to design products that will wow you and your customers.</p>
                    <p>If you have photos that need editing, we can help! We can use Photoshop to make your photos look the best they can, whether you need color adjustments, removing backgrounds or adding elements to your photo.</p>
                    <p>We use Photoshop to it's full potential and strive to always improve our skills on a daily basis.</p>
                    <p>Make sure to check out our print services if you would like our team to see your project all the way through.</p>
