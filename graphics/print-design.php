...
?>
<div class="wrapper">
	<div id="printDesign" class="pageContent webDesign">
    	<h1>Make your Print Material Wow your Customers</h1>
        <a href="<?php echo $siteroot; ?>portfolio/"><img class="portfolio" src="<?php echo $siteroot; ?>images/portfolio_btn.png" width="213" height="84" border="0" /></a>		<img class="main_graph" src="../images/print-design.jpg" width="" height="" border="0">						
    </div>
</div>
<div id="content">
    ...
    <div id="contentBody">
    	<div class="wrapper">
        	<div class="welcome">
                <div class="left">
                	<h1>Increase the success of your print material with professional design</h1>
                    <p>Get the best return out of all your marketing / print materials with the aid of professional design from Markit Media. We give consultations to all of our customers to make sure you can yield the results you want. </p>
                    <p>Our design team will help your printed materials stand out from your competitors, with a professional design that you will be proud to have represent your company. No matter what medium you want to use for your marketing campaigns, our design team will help make breath taking materials to wow your customers.</p>
                    <p>Be sure to pair our design and print services for some great deals and presentation.</p>
                </div>
                <div class="right">
