...
//get vars
$page = 3;
$pageName = 'Design - Adobe Illustrator';
...
?>
<div class="wrapper">
	<div id="adobeIllustrator" class="pageContent webDesign">
    	<h1>Adobe Illustrator Experts for all of your Design Needs.</h1>
        <a href="<?php echo $siteroot; ?>portfolio/"><img class="portfolio" src="<?php echo $siteroot; ?>images/portfolio_btn.png" width="213" height="84" border="0" /></a>		<img class="main_graph" src="../images/adobe-illustrator.jpg" width="" height="" border="0">						
    </div>
</div>
<div id="content">
    ...
    <div id="contentBody">
    	<div class="wrapper">
        	<div class="welcome">
                <div class="left">
                	<h1>Adobe Illustrator and Vector Design</h1>
                    <p>Our design team knows when to use the right tools for the right job, that's why we are  specialized in a variety of programs.  Adobe Illustrator is one of those very programs that we use to design professional logos, business cards, flyers and more.</p>
                    <p>If you have a specific need from your printer, we can deliver any file type for the job. With the use of Adobe Illustrator we deliver beautiful works of art in vector format to ensure you get the highest quality product.</p>
