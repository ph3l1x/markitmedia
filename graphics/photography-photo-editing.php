...
//get vars
$page = 3;
$pageName = 'Design - Photography / Photo Editing';
...
?>
<div class="wrapper">
	<div id="photographyPhotoEditing" class="pageContent webDesign">
    	<h1>Professional Photography and Photo Editing</h1>
        <a href="<?php echo $siteroot; ?>portfolio/"><img class="portfolio" src="<?php echo $siteroot; ?>images/portfolio_btn.png" width="213" height="84" border="0" /></a>		<img class="main_graph" src="../images/photography-photo-editing.jpg" width="" height="" border="0">						
    </div>
</div>
<div id="content">
    ...
    <div id="contentBody">
    	<div class="wrapper">
        	<div class="welcome">
                <div class="left">
                	<h1>Get the Professional Look with Photography and Photo Editing</h1>
                    <p>Whether you are a large or small business, photography can really set you apart from your competition. Having professional photographs of your products or staff can really portray your essence to new and potential customers.</p>
                    <p>If you don't have the staff or products, we have a vast selection of stock photography that will pair well with any of our web design or printed material. We also offer photo editing services to give you the professional look that you see in magazines and big companies. Have your photos look their best with the aid of our design team.</p>
                </div>
                <div class="right">
