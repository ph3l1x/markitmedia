...
class Duplicate_Page_And_Post {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_action_duplicate', $plugin_admin, 'admin_duplicate_post_as_draft' );
		$this->loader->add_action( 'post_row_actions', $plugin_admin, 'admin_duplicate_post_link', 10, 2 );
		$this->loader->add_action( 'page_row_actions', $plugin_admin, 'admin_duplicate_post_link', 10, 2 );
