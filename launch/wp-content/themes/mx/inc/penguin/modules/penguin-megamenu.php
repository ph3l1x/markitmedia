...
class PenguinMegaMenu {
	...
	function penguin_nav_menu_item_custom($menu_item){
		global $penguin_nav_menus;
		if(empty($penguin_nav_menus)){
			$penguin_nav_menus = array();
		}
		$post_fields = array(
		...
		$penguin_nav_menus[$menu_item->ID] = [];
		foreach($post_fields as $field){
			$penguin_nav_menus[$menu_item->ID][$field['key']] = get_post_meta( $menu_item->ID, '_'.$field['name'], true );
		}
    	return $menu_item;
	}
...
class Penguin_Walker extends Walker {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		global $penguin_nav_menus;
		$current_penguin_menu = $penguin_nav_menus[$item->ID];
		...
		if($depth == 0){
			if($current_penguin_menu['megamenu'] == "enabled"){
				$this->megamenu_enabled = true;
				$classes[] = 'mega-menu-main';
				if($current_penguin_menu['megadirection'] != ''){
					$this->megamenu_direction = $current_penguin_menu['megadirection'];
				}else{
					$this->megamenu_direction = 'horizontal';
				}
				if($current_penguin_menu['megawide'] == "enabled"){
		...
		if($depth != 0 && $this->megamenu_enabled ){
			if($this->megamenu_direction == 'horizontal' && $current_penguin_menu['megawidget'] != ""){
				ob_start();
				generated_dynamic_sidebar($current_penguin_menu['megawidget']);
				$widget_content = ob_get_clean();
				$item_output .= '<div class="mega-custom-widget-content">'.$widget_content.'</div>';
			}else if($current_penguin_menu['megaimgenable'] == "enabled" && $current_penguin_menu['megaimage'] != ""){
				if($current_penguin_menu['megaimglink'] != ""){
					
					$item_output .= '<a class="mega-menu-item-img-link" href="'.esc_url( $megaimglink ).'"><div class="mega-menu-item-img"><img src="'.esc_url( $current_penguin_menu['megaimage'] ).'" alt="" ></div></a>';
					
				}else{
					$item_output .= '<div class="mega-menu-item-img"><img src="'.esc_url( $current_penguin_menu['megaimage'] ).'" alt="" ></div>';
				}
				
				if($current_penguin_menu['megadescription'] != ""){
					$item_output .= '<div class="mega-menu-item-desc">'.esc_html( $current_penguin_menu['megadescription'] ).'</div>';
				}
				...
				if($current_penguin_menu['megashorttitle'] != ""){
					$item_output .= '<span class="mega-menu-item-stitle">'.esc_attr( $current_penguin_menu['megashorttitle'] ).'</span>';
				}
				$item_output .= '</a>';
				
				if($current_penguin_menu['megaimage'] != ""){
					if($current_penguin_menu['megaimglink'] != ""){
						$item_output .= '<a class="mega-menu-item-img-link" href="'.esc_url( $current_penguin_menu['megaimglink'] ).'"><div class="mega-menu-item-img"><img src="'.esc_url( $current_penguin_menu['megaimage'] ).'" alt="" ></div></a>';
					}else{
						$item_output .= '<div class="mega-menu-item-img"><img src="'.esc_url( $current_penguin_menu['megaimage'] ).'" alt="" ></div>';
					}
				}
...
class Penguin_Walker_Nav_Menu_Edit extends Walker_Nav_Menu {
	 ...
	 */
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		global $_wp_nav_menu_max_depth, $penguin_nav_menus;
		$current_penguin_menu = $penguin_nav_menus[$item->ID];
		...
		if ( 0 == $depth ){
			...
			if(isset($current_penguin_menu['megamenu']) && $current_penguin_menu['megamenu'] == "enabled"){
            	...
            	<div class="penguin-megamenu">
                	...
                	<p class="penguin-megamenu-enable">
                    	<label for="edit-menu-item-megamenu-<?php echo $item_id; ?>">
                            <input type="checkbox" class="penguin-megamenu-enable-checkbox" id="edit-menu-item-megamenu-<?php echo $item_id; ?>" value="enabled" name="menu-item-megamenu[<?php echo $item_id; ?>]" <?php checked( $current_penguin_menu['megamenu'], 'enabled' ); ?>/>
                            <?php _e( 'Mega Menu Enabled',Penguin::$THEME_NAME ); ?>
                        </label>
                    </p>
                    
                    <p class="penguin-megamenu-direction">
                    	<?php if($current_penguin_menu['megadirection'] == '') { $current_penguin_menu['megadirection'] = 'horizontal'; } ?>
                    	<label for="edit-menu-item-megadirection-<?php echo $item_id; ?>-1">
                            <input type="radio" id="edit-menu-item-megadirection-<?php echo $item_id; ?>-1" value="horizontal" name="menu-item-megadirection[<?php echo $item_id; ?>]" <?php checked( $current_penguin_menu['megadirection'], 'horizontal' ); ?>/>
                            <?php _e( 'Horizontal',Penguin::$THEME_NAME ); ?>
                        </label>
                        
                        <label for="edit-menu-item-megadirection-<?php echo $item_id; ?>-2">
                            <input type="radio" id="edit-menu-item-megadirection-<?php echo $item_id; ?>-2" value="vertical" name="menu-item-megadirection[<?php echo $item_id; ?>]" <?php checked( $current_penguin_menu['megadirection'], 'vertical' ); ?>/>
                    ...
                    <p class="penguin-megamenu-wideenable">
                    	<label for="edit-menu-item-megawide-<?php echo $item_id; ?>">
                            <input type="checkbox" class="penguin-megamenu-megawide-checkbox" id="edit-menu-item-megawide-<?php echo $item_id; ?>" value="enabled" name="menu-item-megawide[<?php echo $item_id; ?>]" <?php checked( $current_penguin_menu['megawide'], 'enabled' ); ?>/>
                   	...
                   	<p class="penguin-megamenu-megaimgenable">
                    	<label for="edit-menu-item-megaimgenable-<?php echo $item_id; ?>">
                            <input type="checkbox" class="penguin-megamenu-megaimgenable-checkbox" id="edit-menu-item-megaimgenable-<?php echo $item_id; ?>" value="enabled" name="menu-item-megaimgenable[<?php echo $item_id; ?>]" <?php checked( $current_penguin_menu['megaimgenable'], 'enabled' ); ?>/>
                    ...
                    <p class="penguin-megamenu-megawidget">
                        <label for="edit-menu-item-megawidget-<?php echo $item_id; ?>">
                            ...
                            <input type="text" id="edit-menu-item-megawidget-<?php echo $item_id; ?>" class="widefat code edit-menu-item-megawidget" name="menu-item-megawidget[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $current_penguin_menu['megawidget'] ); ?>" />
                        </label>
                    </p>
                    ...
                    <p class="penguin-megamenu-megashorttitle">
                        <label for="edit-menu-item-megashorttitle-<?php echo $item_id; ?>">
                            ...
                            <input type="text" id="edit-menu-item-megashorttitle-<?php echo $item_id; ?>" class="widefat code edit-menu-item-megashorttitle" name="menu-item-megashorttitle[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $current_penguin_menu['megashorttitle'] ); ?>" />
                        </label>
                    </p>
                    ...
                    <p class="penguin-megamenu-megaimage">
                        <label for="edit-menu-item-megaimage-<?php echo $item_id; ?>">
                            ...
                            <input type="text" id="edit-menu-item-megaimage-<?php echo $item_id; ?>" class="widefat code edit-menu-item-megaimage" name="menu-item-megaimage[<?php echo $item_id; ?>]" value="<?php echo esc_url( $current_penguin_menu['megaimage'] ); ?>" />
                        </label>
                    </p>
                     ...
                     <p class="penguin-megamenu-megaimglink">
                        <label for="edit-menu-item-megaimglink-<?php echo $item_id; ?>">
                            ...
                            <input type="text" id="edit-menu-item-megaimglink-<?php echo $item_id; ?>" class="widefat code edit-menu-item-megaimglink" name="menu-item-megaimglink[<?php echo $item_id; ?>]" value="<?php echo esc_url( $current_penguin_menu['megaimglink'] ); ?>" />
                        </label>
                    </p>
                    ...
                    <p class="penguin-megamenu-megadescription">
                        <label for="edit-menu-item-megadescription-<?php echo $item_id; ?>">
                            ...
                            <textarea id="edit-menu-item-megadescription-<?php echo $item_id; ?>" class="widefat edit-menu-item-megadescription" rows="3" cols="20" name="menu-item-megadescription[<?php echo $item_id; ?>]"><?php echo esc_html( $current_penguin_menu['megadescription'] ); // textarea_escaped ?></textarea>
                        </label>
                    </p>
