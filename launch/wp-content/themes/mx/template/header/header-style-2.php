 ...
 */
?>
<header id="site-header" class="site-header-style-2 <?php echo mx_get_options_key('header-fixed-menu-enable') == "on" ? "header-fixed-support" : "";?>">
    <div id="mx-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="mx-header-right">
                        ...
                        <?php 
						$right_content = '';
						if(mx_get_options_key('header-search-enable') == "on" || mx_get_options_key('global-login-enable') == "on" || (class_exists( 'woocommerce' ) && mx_get_options_key('woocommerce-cart-enable') == "on")){
							$right_content = 'have-content';
						}?>
                        <div class="mx-search-container <?php echo $right_content; ?>">
                            <ul class="inline">
