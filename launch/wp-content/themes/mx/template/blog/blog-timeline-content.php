...
if($layout == 1){
	$blog_ajax_columns = 'col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2';
}else{
	$blog_ajax_columns = 'col-md-12 col-sm-12';
}
...
<div class="ajax-main-area">
    ...
    <?php 
        while ( $blog_posts->have_posts() ) {
            $blog_posts->the_post();
    ?>
        <?php get_template_part( 'template/blog/blog', 'timeline-content-item-style-'.$blog_ajax_style); ?>
    <?php } ?>
    </section>
    <?php 
