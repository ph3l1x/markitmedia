...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('post-ajax-element blog-timeline-style-2 '.$blog_ajax_columns); ?> itemscope itemtype="http://schema.org/Article">
    <div class="post-timeline-element-container">
    	<span class="timeline"></span>
        <span class="timeline-hor"></span>
        <div class="post-meta">
            ...
            ?>
                <div class="post-element-content">
                    <div class="flexslider mx-fl post-gallery">
                        ...
                        ?>
                            <li>
                                <a href="<?php echo esc_url($full_image[0]); ?>" class="fancybox-thumb" rel="fancybox-thumb[post-time-c2-<?php echo get_the_ID(); ?>]"><img src="<?php echo esc_url($attachment_image[0]); ?>" alt=""></a>
                            </li>
                        <?php }?>
                        </ul>
                    </div>
