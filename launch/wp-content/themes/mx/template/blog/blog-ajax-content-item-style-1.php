...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('post-ajax-element blog-ajax-style-1 '.$blog_ajax_columns); ?> itemscope itemtype="http://schema.org/Article">
    <div class="post-ajax-element-container">
            ...
            ?>
                <div class="post-element-content">
                    <div class="flexslider mx-fl post-gallery">
                        ...
                        ?>
                            <li>
                                <a href="<?php echo esc_url($full_image[0]); ?>" class="fancybox-thumb" rel="fancybox-thumb[post-ajax-c1-<?php echo get_the_ID(); ?>]"><img src="<?php echo esc_url($attachment_image[0]); ?>" alt=""></a>
                            </li>
                        <?php }?>
                        </ul>
                    </div>
        ...
        <?php } ?>
        <footer>
            <span class="author vcard"><a class="url fn n" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author"><span itemprop="author"><?php echo get_the_author(); ?></span></a></span>
