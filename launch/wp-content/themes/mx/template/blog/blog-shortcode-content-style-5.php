...
$output .= '<div class="post-element-content">
				<div class="flexslider mx-fl post-gallery">
                    ...
                    foreach($img_list as $item_id){
                    	...
                    	$output .= '<li><a href="'.esc_url($full_image[0]).'" class="fancybox-thumb" rel="fancybox-thumb[post-code-c4-'.get_the_ID().']"><img src="'.esc_url($attachment_image[0]).'" alt=""></a></li>';
                	}
$output .= '		</ul>
				</div>
			</div>';
...
$output .= '<span class="comments-link"><i class=" fa fa-heart"></i>'.penguin_get_post_meta_count(get_the_ID(),1,false).'</span>';
