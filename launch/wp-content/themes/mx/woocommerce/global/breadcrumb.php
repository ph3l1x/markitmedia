...
if(mx_get_post_meta_key( 'title-show', $p_ID) != "off"){
?>
	...
	<header id="site-content-header">
			<div class="container">
				<div class="page-title">
					<?php 
						$title 	= 	mx_get_post_meta_key('title-content', $p_ID);
						$desc	=	mx_get_post_meta_key('title-desc', $p_ID);
						$enable_breadcrumb	=	mx_get_post_meta_key('title-breadcrumb', $p_ID);
						if($title == ''){ 
							echo '<h1 class="title">';
							if(is_single()){
								echo get_the_title();
