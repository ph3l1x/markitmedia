...
<div id="incident_nav_wrap">
	...
	<ul id="incident_nav">
		<?php if($data_record_id && $data_record_id != 'new'){ ?>
            ...
            <li>
                <a href="<?php echo $_SERVER['REQUEST_URI'].'&print=true';?>" onclick="window.open(this.href,'pop','width=900,height=700,scrollbars=1'); return false;"><?=_l('Print');?></a>
            </li>
            ...
            <li class="<?php echo ($mode=='admin')?'link_current':'';?>">
                <a href="<?php echo module_data::link_open_data_type($data_type_id);?>"><?=_l('Settings');?></a>
            </li>
            <?php } ?>
		<?php }else{ /*?>
            <li class="<?php echo ($mode=='edit')?'link_current':'';?>">
