...
<title>Markit Media - Web, Marketing, Graphics and Print in Scottsdale - <?php echo $title; ?></title>
			...
			<li>
				...
				<script type="text/javascript"> 
				  ...
				  google.setOnLoadCallback(function() {
					...
					options.enableSearchboxOnly("http://markitmedia.com/google-search");
...
<div class="wrapper">
	<div id="header">
        ...
        <div id="follow">
            ...
            <a href="https://plus.google.com/116169153629019849688/posts" target="_blank" rel="author"><img src="<?php echo $siteroot; ?>images/googleplus.png" width="30" height="30" border="0" /></a>
        </div>
        <div id="phone">
        	<h1>480.245.4287</h1>
        </div>
